      ...
      <KeyboardAvoidingView 
        ...
        >
            <View style={styles.main}>
                ...
                <View>
                  <Text style={styles.title}>Seu market de coleta de resíduos</Text>
                  <Text style={styles.description}>Ajudamos pessoas a encontrarem ponttos de coleta de forma eficiente.</Text>
                </View>
            </View>
